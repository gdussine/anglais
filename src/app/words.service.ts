  ...
  lists: WordList[] = [
    ...
    },
    {
      ...
      words: [{fr: 'Croire en quelque chose', eng: 'believe in'},
        ...
        {fr: 'être à la hauteur de', eng: 'live up to'},
        {fr: 'Voir quelque chose d\'une certaine manière', eng: 'look at'},
        {fr: 'admirer', eng: 'look up to'},
        {fr: 'être en désaccord avec', eng: 'object to'},
        {fr: 's\'opposer à', eng: 'oppose to'},
        {fr: 's\'en prendre à', eng: 'pick on'},
        {fr: 'rabaisser', eng: 'put down'},
        {fr: 'décourager', eng: 'put off'},
        {fr: 'supporter', eng: 'put up with'},
        {fr: 'trouver que quelqu\'un a une qualité', eng: 'see as'},
        {fr: 'se contenter de', eng: 'settle for'},
        {fr: 'frimer', eng: 'show off'},
        {fr: 'soutenir', eng: 'stand for'},
        {fr: 'partir pour signifier son mécontentement', eng: 'walk out'}]
    },
    {
      id: 4,
      ...
      words: [{fr: 'rappeler', eng: 'bring back'},
        ...
        {fr: 'entendre parler de (pour la première fois)', eng: 'hear of'},
        {fr: 'être bien informé sur', eng: 'know about'},
        {fr: 'repenser à quelque chose', eng: 'look back'},
        {fr: 'transmettre', eng: 'pass on'},
        {fr: 'rappeler quelque chose à quelqu\'un', eng: 'remind of'},
        {fr: 'rester gravé dans l\'esprit', eng: 'stick in'},
        {fr: 'penser à', eng: 'think of'},
        {fr: 'résoudre / calculer', eng: 'work out'}]
    },
    {
      id: 5,
      ...
      words: [{fr: 'aimt at', eng: 'viser'},
        ...
        {fr: 'pull off', eng: 'réussir (à faire quelque chose)'},
        {fr: 'rule out', eng: 'écarter'},
        {fr: 'run into', eng: 'renconter (des problèmes)'},
        {fr: 'set out', eng: 'entreprendre'},
        {fr: 'start on', eng: 'commencer avec'},
        {fr: 'turn out', eng: 's\'avérer'},
    ...
    },
    {
      ...
      words: [{fr: 'foremost', eng: 'principal'},
        ...
        {fr: 'overwhelming', eng: 'écrasant'},
        {fr: 'peculiar', eng: 'curieux, particulier'},
        {fr: 'convenient', eng: 'commode'},
        {fr: 'armoured', eng: 'blindé'},
        {fr: 'reckless', eng: 'irréfléchi'},
        {fr: 'straightforward', eng: 'simple, direct'},
        {fr: 'unaware of …', eng: 'inconscient de …'},
        {fr: 'barely', eng: 'à peine'},
        {fr: 'to envision', eng: 'envisager, prévoir'},
        ...
        {fr: 'mortgage', eng: 'l’hypothèque'},
        {fr: 'to shrink', eng: 'rétrécir'}]
    },
    {
      id: 7,
      name: 'Nombre',
